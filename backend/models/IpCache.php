...
use common\models\IpCache as CommonIpCache;


class IpCache extends CommonIpCache
{
    use ApiTrait;
    ...
    public function getOne($id){
        $model = IpCache::find()->where(['id'=>$id])->asArray()->one();
        if(!$model){
...
//        $data['group_id'] = $group_id;
    ...
    public function del($data)
    {
        ...
        $model = IpCache::deleteAll(['in','id',$ids]);
            return $this->success();
